...
public class Circle implements CarListener {
	...
	public Circle(PApplet a, SensorData sensorData, SolarAnalyticsAPI api, PGraphics c) {
		applet = a;
	...
	void smoothCircle(float r) {
		...
		canvas.fill(calcColor(60, applet.color(255, 60, 30, 88), applet.color(255, 60, 30, 150), applet.color(255, 60, 30, 200)));
		//canvas.fill(calcColor(r, applet.color(244, 99, 97, 88), applet.color(222, 212, 111, 88), applet.color(200, 31, 255, 150)));

		for (int n = 0; n < 5; n++) {
			canvas.ellipse(x-6, y+3, rad * applet.pow(0.8f, n),
